...
function test()
{
    ...
    let xmasDate = parseInt(new Date(tempDate.getFullYear(), 11, 23, 0, 0, 0, 0).getTime());
    ...
    let output = Math.floor(days) + " dny " + Math.floor(minutes) + " minuty " + Math.floor(seconds) + " vteriny" + Math.floor(miliseconds) + " milisekundy ";
